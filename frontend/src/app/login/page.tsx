    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to your Reef & Beach Safety account</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 space-y-2 text-sm text-muted-foreground">
              <p>• free@test.com / password123 (Free)</p>
              <p>• consumer@test.com / password123 ($4.99)</p>
              <p>• business@test.com / password123 ($49)</p>
            </div>
          </div>
        </CardContent>
